import { getDailyName } from './names.js';
...
export async function shareResult(resultGrid, guessCount) {
  ...
  if (navigator.share) {
    try {
      // URL is already at the end of `text`. Passing `url` duplicates it in
      // WhatsApp, Mail, and other targets that append both fields.
